...
public interface IPostalCodeInfoRepository extends CrudRepository<PostalCodeInfo,Long> {
    ...
    //@Query("select pi from PostalCodeInfo pi where pi.postalCode.postalCode =:postalCodeRequest")
    Iterable<PostalCodeInfo> findByPostalCode(String postalCodeRequest);
}
