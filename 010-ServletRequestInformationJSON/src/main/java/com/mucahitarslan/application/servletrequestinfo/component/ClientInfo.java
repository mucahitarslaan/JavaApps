package com.mucahitarslan.application.servletrequestinfo.component;
...
public class ClientInfo {
    ...
    public String toString() {
        ...
        var formatStr = "Local Address: %s, Remote Address : %s, Remote Host : %s, Local Port : %d, Remote Port : %d, Request Time : %s";

        return String.format(formatStr,m_localAddress,m_remoteAddress,m_remoteHost,m_localPort,m_remotePort, formatter.format(m_localDateTime));
    }
}
